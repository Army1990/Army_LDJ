...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    /**
     * item之间分割线的color, 默认为Color.GRAY
     */
    private int mItemColor = Color.GRAY;
    ...
    /**
     * 构造方法传入布局方向，分割线size，分割线颜色
     *
     * @param context
     * @param orientation
     * @param mItemSize   分割线size
     * @param mItemColor  分割线颜色
     */
    public DividerItemDecoration(Context context, int orientation, int mItemSize, int mItemColor) {
     ...
     *
     * @param context
     * @param mOrientation LinearLayoutManager.VERTICAL || LinearLayoutManager.HORIZONTAL
     */
